    ...
    <main className="min-h-screen bg-parchment dark:bg-dark-bg transition-colors duration-700 pb-20">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 space-y-8 md:space-y-12 animate-in fade-in duration-1000 pt-32 md:pt-8">
        <div className="text-center space-y-4">
          <span className="text-gold uppercase tracking-[0.3em] md:tracking-[0.5em] text-[8px] md:text-[10px] font-bold serif">
          ...
          <p className="text-sm md:text-xl italic serif text-ink/60 dark:text-dark-text/60">
            {isFaculty ? "Your contribution to our legacy is immeasurable." : "Guys it's that time of the year."}
          </p>
        </div>

        {!isFaculty && (
          <div className="w-full max-w-4xl px-2 md:px-0" id="stats-section">
