...
function LandingFooter() {
  ...
  return (
    <footer className="w-full bg-zinc-950 border-t border-gold/10 py-24 px-8 relative overflow-hidden">
      {/* Background Ambience */}
...
function ThemedFooter() {
  ...
  return (
    <footer className="footer-dark w-full py-20 px-8 relative overflow-hidden border-t-2" style={{ borderColor: 'var(--color-footer-burgundy)' }}>

      {/* Ambient glows */}
      <div className="absolute top-0 left-0 w-96 h-96 rounded-full blur-[180px] pointer-events-none opacity-20" style={{ background: 'var(--color-footer-burgundy)' }} />
      <div className="absolute bottom-0 right-0 w-80 h-80 rounded-full blur-[150px] pointer-events-none opacity-15" style={{ background: 'var(--color-footer-rust)' }} />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-32 rounded-full blur-[120px] pointer-events-none opacity-10" style={{ background: 'var(--color-footer-gold)' }} />

      {/* Top horizontal rule with gold gradient */}
      ...
      <div className="max-w-7xl mx-auto space-y-16 relative">
        ...
        {/* ── WELCOME circuit word ─────────────────── */}
        <div className="text-center">
          <span
            className="font-circuit text-[11px] tracking-[0.5em] uppercase"
            style={{ color: 'var(--color-footer-rust)' }}
          >
            // welcome
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="flex items-center gap-4">
              <div
                ...
                style={{ background: 'rgba(212,175,55,0.12)', border: '1px solid rgba(212,175,55,0.25)', color: 'var(--color-footer-gold)' }}
              >
                <Sparkles size={22} />
              </div>
              <div>
                <h3 className="text-2xl font-bold serif tracking-tight footer-text-bright">Cheerio 2026</h3>
                <p className="text-[9px] font-bold uppercase tracking-[0.45em] footer-text-rust mt-0.5">
                  Official Farewell Portal
                </p>
              </div>
            </div>
            ...
            <div
              ...
              style={{ borderLeft: '3px solid var(--color-footer-burgundy)' }}
            >
              <p className="serif italic text-base leading-relaxed footer-text-mid">
                &quot;Welcoming everyone to their own official farewell website. A digital sanctuary where memories are reclaimed and legacies are solidified.&quot;
              </p>
              <p className="font-circuit text-[10px] mt-3 footer-text-sepia tracking-widest">
                — yours truly
              </p>
            </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-10">
            ...
            <div className="space-y-5">
              <h4
                className="text-[9px] font-bold uppercase tracking-[0.35em] pb-2 border-b"
                style={{ color: 'var(--color-footer-rust)', borderColor: 'rgba(160,82,45,0.25)' }}
              >
                Neural Connections
              </h4>
              <div className="flex flex-col gap-4">
                {socialLinks.map((social) => (
                  ...
                  >
                    ...
                    <span
                      className="text-[10px] font-bold uppercase tracking-widest transition-colors footer-text-mid group-hover:footer-text-gold"
            ...
            <div className="space-y-5">
              <h4
                className="text-[9px] font-bold uppercase tracking-[0.35em] pb-2 border-b"
                style={{ color: 'var(--color-footer-sepia)', borderColor: 'rgba(139,115,85,0.25)' }}
              >
                The Architects
              </h4>
              <div className="space-y-2">
                <p className="text-xs font-bold uppercase tracking-widest footer-text-bright leading-6">
                  Made by 3rd Year
                </p>
                <p className="text-xs font-bold uppercase tracking-widest footer-text-mid leading-6">
                  For the Seniors
                </p>
                <p className="text-xs font-bold uppercase tracking-widest footer-text-muted leading-6">
                  By the Juniors
                </p>
              </div>
            </div>
            ...
            <div className="space-y-5">
              <h4
                className="text-[9px] font-bold uppercase tracking-[0.35em] pb-2 border-b"
                style={{ color: 'var(--color-footer-gold)', borderColor: 'rgba(212,175,55,0.2)' }}
              >
                Ethos
              </h4>
        ...
        {/* ── THANK YOU circuit word ───────────────── */}
        <div className="text-center">
          <span
            className="font-circuit text-[10px] tracking-[0.6em] uppercase"
            style={{ color: 'var(--color-footer-gold)', opacity: 0.5 }}
          >
            // thank you
          </span>
        </div>
